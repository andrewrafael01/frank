...
export default function EvaluationLab() {
  ...
  const getCaseSummary = () => {
    ...
    if (systemResponsibility === max) {
      return 'Your evaluation places shared responsibility between the character and puts society as the most responsible. The tragedy was caused by social conditions that caused separation and prevented repair.'
    } else if (victorResponsibility === max) {
      return 'Your evaluation places most responsibility on Victor Frankenstein. His abandonment, broken promises, and refusal to acknowledge responsibility plays the largest role in the tragedy.'
    } else if (creatureResponsibility === max) {
      return 'Your evaluation places most responsibility on the Creature. Despite trauma and rejection, it consciously chose violence and can not be excused.'
    } else {
                ...
                <div className="responsibility-bars">
                  <div className="responsibility-bar-item">
                    <div className="bar-label-row">
                      <span className="bar-main-label">VICTOR</span>
                  ...
                  <div className="responsibility-bar-item">
                    <div className="bar-label-row">
                      <span className="bar-main-label">CREATURE</span>
                      <span className="bar-sub-label">RESPONSIBILITY</span>
                    </div>
                    <div className="bar-container">
                      <div 
                  ...
                  <div className="responsibility-bar-item">
                    <div className="bar-label-row">
                      <span className="bar-main-label">Society</span>
                      <span className="bar-sub-label">RESPONSIBILITY</span>
                    </div>
                    <div className="bar-container">
                      <div 
