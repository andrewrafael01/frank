...
export default function CaseReport() {
  ...
  const getNarrativeSummary = () => {
    ...
    if (systemResponsibility === max) {
      ...
      return `Your case file leans toward Victor as primarily responsible (${victorPct}%). His warning "Learn from me, if not by my precepts, at least by my example, how dangerous is the acquirement of knowledge" becomes his way of admitting guilt. Victor pursued knowledge without considering consequences, created life without accepting responsibility, and abandoned his creation. The Creature's saying, "Remember that I am thy creature; I ought to be thy Adam, but I am rather the fallen angel," shows Victor's failure of creating a child but refusing to be a parent. His actions play the largest role in causing the tragedy.`
