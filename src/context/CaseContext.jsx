...
const DIAGNOSTIC_DOMAINS = [
  ...
  { id: 2, label: 'Attachment & Recognition Desires', key: 'attachment' },
  { id: 3, label: 'Violence Motivation', key: 'violence' },
  { id: 4, label: 'Remorse', key: 'remorse' },
  { id: 5, label: 'External Factors', key: 'societal' },
  { id: 6, label: 'Opportunity for De-Escalation', key: 'deEscalation' }
]
